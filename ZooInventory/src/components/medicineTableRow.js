...
class TableRow extends Component {
    ...
    deletesss(){
        axios.get('http://localhost:4000/zooInventory/deletemedicine/'+this.props.obj._id)
    ...
    render() {
        return (
           <tr>
               ...
               <td>
                   {this.props.obj.edate}
               </td>
               <td>
                   {this.props.obj.uprice}
               </td>
               <td>
                   {this.props.obj.vender}
               </td>
               <td>
                   {this.props.obj.reorderlevel}
               </td>
               <td>
                   <Link to={"/editMedicine/"+this.props.obj._id} className="btn btn-success">Edit</Link>
                   &nbsp;
